...
const Registration = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('https://society-management-syste-4b7b1-default-rtdb.asia-southeast1.firebasedatabase.app/flatsRegistration.json', formData)
        ...
        <>
            ...
            <div className='col-md-6 mx-auto'>
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="form-group row">
                        <label htmlFor="previousYearDues" className="col-sm-2 col-form-label">Previous Year Dues Amount</label>
                        <div className="col-sm-10">
                            <input type="text" className="form-control" id="previousDues" name="previousYearDues" onChange={handleChange} />
                        </div>
                    </div>
                    <div className="form-group row">
                        <label htmlFor="isRented" className="col-sm-2 col-form-label">isRented</label>
                        <div className="col-sm-10">
                            <select class="form-control" name="isRented" onChange={handleChange}>
                                <option>Yes</option>
                                <option>No</option>
                            </select>
                        </div>
